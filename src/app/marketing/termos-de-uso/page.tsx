            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-10">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-zinc-400">
                            <li><strong className="text-zinc-200">Plano Gratuito:</strong> limitado a {PRICING.freeQuotesPerMonth} orçamentos por mês, com marca d&apos;água Zacly nos documentos. Disponível por tempo indeterminado, podendo ter limitações alteradas mediante aviso prévio de 30 dias.</li>
