            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-10">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-zinc-400">
                            <li><strong className="text-zinc-200">Plano Gratuito:</strong> limitado a {PRICING.freeActivationQuotes} propostas simples nos primeiros {PRICING.freeActivationWindowDays} dias, depois {PRICING.freeQuotesPerMonth} proposta simples por mes, e {PRICING.proSampleQuotes} proposta de degustacao Pro por conta. A proposta simples pode manter marca Zacly e personalizacao limitada. Disponivel por tempo indeterminado, podendo ter limitacoes alteradas mediante aviso previo de 30 dias.</li>
