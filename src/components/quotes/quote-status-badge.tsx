...
const statusMap = {
    // Status ativos do pipeline
    draft: { label: 'Criado', color: 'bg-zinc-100 text-zinc-800 border-zinc-200 hover:bg-zinc-100' },
    pending: { label: 'Criado', color: 'bg-zinc-100 text-zinc-800 border-zinc-200 hover:bg-zinc-100' },
    ...
    changes_requested: { label: 'Ajuste Solicitado', color: 'bg-amber-100 text-amber-800 border-amber-200 hover:bg-amber-100' },
