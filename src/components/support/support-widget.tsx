        ...
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
                ...
                <div className="flex border-b border-border bg-muted/30">
                    <button
                        className={`flex-1 py-3 text-sm font-medium transition-colors flex items-center justify-center gap-2 ${activeTab === 'faq'
                    ...
                    <button
                        className={`flex-1 py-3 text-sm font-medium transition-colors flex items-center justify-center gap-2 ${activeTab === 'ticket'
                                ? 'text-emerald-600 border-b-2 border-emerald-500 bg-background'
                                : 'text-muted-foreground hover:text-foreground'
                            }`}
                ...
                {/* Content Area */}
                <div className="max-h-[60vh] sm:max-h-[400px] overflow-y-auto p-4 bg-background scrollbar-thin scrollbar-thumb-border">
                    {/* FAQ TAB */}
                    {activeTab === 'faq' && (
                        <div className="animate-in fade-in slide-in-from-left-2 duration-300">
                            <Accordion type="single" collapsible className="w-full">
                                ...
                                <AccordionItem value="item-3" className="border-border">
                                    ...
                                    <AccordionContent className="text-muted-foreground leading-relaxed">
                                        <span className="inline-block px-2 py-0.5 bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400 rounded text-xs font-bold mb-2">Em Análise</span><br />
                                ...
                                <AccordionItem value="item-4" className="border-border border-b-0">
                                    <AccordionTrigger className="text-sm font-semibold hover:no-underline hover:text-emerald-600">
                        ...
                        <div className="animate-in fade-in slide-in-from-right-2 duration-300">
                            <form action={handleSubmit} className="space-y-4 pt-2">
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-semibold uppercase text-muted-foreground">Motivo do Contato</label>
                                    <div className="grid grid-cols-2 gap-2">
                                        <label className="cursor-pointer">
                                            <input type="radio" name="type" value="doubt" className="peer sr-only" defaultChecked />
                                            <div className="rounded-lg border-2 border-border p-3 text-center peer-checked:border-emerald-500 peer-checked:bg-emerald-500/10 peer-checked:text-emerald-600 transition-all">
                                        ...
                                        <label className="cursor-pointer">
                                            ...
                                            <div className="rounded-lg border-2 border-border p-3 text-center peer-checked:border-amber-500 peer-checked:bg-amber-500/10 peer-checked:text-amber-500 transition-all">
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="subject" className="text-xs font-semibold uppercase text-muted-foreground">Assunto</label>
                                    <input
                                        id="subject"
                                        name="subject"
                                        type="text"
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="message" className="text-xs font-semibold uppercase text-muted-foreground">Mensagem</label>
                                    <textarea
                                        id="message"
                                        name="message"
                                        required
