...
const FAQ_ITEMS = [
    ...
    { category: 'Orçamentos', q: 'Quantos orçamentos posso criar no plano gratuito?', a: `O plano gratuito permite ${PRICING.freeQuotesPerMonth} proposta simples por mes e ${PRICING.proSampleQuotes} deguste Pro por conta. Para propostas ilimitadas e sem marca Zacly, assine o plano Pro.` },
    // Clientes
