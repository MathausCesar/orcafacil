export const DEFAULT_QUOTE_APPROVAL_MESSAGE_TEMPLATE = [
    ...
    '',
    'Preparei sua proposta pela {empresa} em um link seguro, com escopo, validade, valor total e aceite do cliente registrados.',
    '',
    'Valor total: {total}',
    '{validade_linha}',
    '',
    'Para visualizar os detalhes e aprovar com seguranca, acesse:',
    '{link}',
    '',
