...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the provided username, fill the password field, then click the 'Acessar Painel' button to attempt login.
        ...
        await expect(frame.locator('text=Total quotes').first).to_be_visible(timeout=3000)
