...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email into the email field, type the provided password into the password field, then click the login button.
        ...
        # -> Click the 'Entrar' link in the header to open the login page (index 728).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/main/header/div/nav/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Fill the login form again with the provided credentials and click 'Acessar Painel' to attempt to authenticate and proceed to the Quotes flow.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[2]/div/div[2]/div/div[3]/form/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('mathauscesar@gmail.com')
