...
async def run_test():
    ...
    try:
        ...
        # -> Input the provided username into the email field (index 6) as the immediate next action. ASSERTION: After input, the email field should contain the test username.
        ...
        await expect(frame.locator('xpath=//button[contains(@aria-label,"Notifications")]/span[contains(@class,"badge")]').first).to_be_visible(timeout=3000)
