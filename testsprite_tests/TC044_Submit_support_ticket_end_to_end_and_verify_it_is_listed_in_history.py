...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email into the email field (index 9) and the provided password into the password field (index 10), then click the 'Acessar Painel' button (index 12).
